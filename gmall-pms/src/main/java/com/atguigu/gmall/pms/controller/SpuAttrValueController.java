...
public class SpuAttrValueController {
    ...
    @PostMapping("search/{categoryId}/{spuId}")
    ...
    public ResponseVo<List<SpuAttrValueEntity>>querySearchSpuAttrValuesByCidAndSpuId(
       ...
       List<SpuAttrValueEntity> spuAttrValueEntities = this.spuAttrValueService.querySearchSpuAttrValuesByCidAndSpuId(categoryId,spuId);
